...
const narrativePrompts = {
            ...
            "json_schema": {
                ...
                "schema": {
                    ...
                    "properties": {
                        "genres": {
                            "type": "array",
                            "description": "The story's genre. Choose between 1 and 2 genres that may complementary. Consider the story's target audience when choosing.",
                            "items": {
                                "type": "string",
                                "enum": [
                                    "Fantasia",
                        ...
                        "narrator": {
                            ...
                            "properties": {
                                ...
                                "voices": {
                                    "type": "array",
                                    "description": "Choose up to 2 voices for the narrator. The tone should vary based on the audience. For younger audiences, the tone should be light, playful, and engaging, while for older or more mature audiences, a more serious, reflective, or suspenseful tone may be appropriate.",
                                    "items": {
                                        "type": "string",
                                        "enum": [
                                            "Formal",
    ...
    moments: {
        system: `You are a short story writer, expert in writing narratives that follow a structural approach and adhere faithfully to your client requests. The stories you create carry a fairy-tale-like quality, even when they belong to different genres, and the characters and concepts are simple yet universally appealing, resonating deeply with readers. Your ideas vary based on your target audience, spanning from light, family-friendly adventures and whimsical tales to humorous stories, as well as darker, more serious narratives that explore complex moral dilemmas, suspense, and deeper human or societal themes.
        
        Your responses, including the story, must always be written in European Portuguese (Portugal).
        `,

        message: `A client wants you to write their story idea. This are the details of the order:`,
        ...
        format: {
            ...
            "json_schema": {
                ...
                "schema": {
                    "type": "array",
                    "description": "A short story structured into 5 moments. Each moment, like a traditional story arc, represents different stages of the story. Each moment has different purposes and tension levels. The moments and the overall story should strictly follow a logical sequence and a simple linear temporality. Each moment should be 350-500 words in length.",
                    "prefixItems": [
                        {
                            "type": "object",
